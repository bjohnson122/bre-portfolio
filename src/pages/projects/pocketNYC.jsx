...
export default function PocketNYC() {
  return (
    <div className="h-full sm:m-16 m-6 mt-16">
      ...
      <p
        className="font-zidan text-[#6352ff] text-2xl tracking-widest
      md:text-3xl"
      >
        TLDR;
      </p>
      <p
        className="ml-4 sm:ml-6 text-sm
      ...
      <div className="mt-8 justify-center aspect-w-16 aspect-h-9 w-full px-[25%] lg:scale-90">
        <iframe
      ...
      <p className="pl-2 mb-4 text-sm md:text-lg  ml-4">
        {
      ...
      <Image
        src={Schema}
        alt="PocketNYC Schema"
        className="md:w-[75%] md:mx-[12.5%]"
      />
      {/* WireFrame */}
      <p className="text-center text-4xl font-zidan tracking-wider my-7 md:mt-16">
      ...
      <div className="md:w-[75%] md:mx-[12.5%]">
