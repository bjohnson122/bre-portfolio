  ...
  return (
    <div>
      <p className="relative w-[87vw] mx-auto text-sm mb-4">
        ...
        <br />
        <br />
        Whether {`it's`} color coordination, picking the right tool for the job,
        or simply viewing something from a different prospective, {`I'm`} always
        finding new ways to apply my creativity and talents to daily tasks.
      </p>
    </div>
  );
}
